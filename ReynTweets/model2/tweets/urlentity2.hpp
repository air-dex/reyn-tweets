...
class URLEntity2 : public TweetEntity2
{
	...
	protected:
		...
		/// @param entity URLEntity to copy
		void recopie(const URLEntity2 & entity);
		...
		friend QDataStream & operator<<(QDataStream & out, const URLEntity2 & entity);
		...
		/// @param entity Object to put in the stream
		/// @return The stream with the object
		friend QDataStream & operator>>(QDataStream & in, URLEntity2 & entity);
