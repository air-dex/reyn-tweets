...
//		bool operator==(const Tweet2 & status);

//		/// @fn virtual void fillWithJSON(QJsonObject json);
//		/// @brief Filling the tweet with a QJsonObject.
//		/// @param json The QJsonObject used to fill the tweet
//		void fillWithJSON(QJsonObject json);

//		// TODO : imporove doc
//		// TODO : implement it
//		/// @fn virtual QJsonValue value(const QString &key) const;
//		/// @brief Special redefinition of QJsonObject::value() in order to
//		/// handle sync between the properties and their JSON value.
//		/// @see QJsonValue QJsonObject::value(const QString &) const
