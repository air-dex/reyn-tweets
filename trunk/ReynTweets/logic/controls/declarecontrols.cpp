/// @file declarecontrols.cpp
/// @brief Implementation of functions to init controls for QVariant and
...
#include "declarecontrols.hpp"

#include "controls.hpp"

// Init for QVariant. Not any controls for the moment
