...
#ifndef USERACCOUNT2_HPP
#define USERACCOUNT2_HPP
...
/// @class UserAccount
/// @brief User account.
class UserAccount2 : public JsonObject
{
	Q_OBJECT
	...
	private:
		...
		/// @param account Account to copy
		void recopie(const UserAccount2 & account);
	...
	private:
		...
		///
		/// user is the attribute beneath this property.
		Q_PROPERTY(UserInfos2 * current_user
				   READ getUserPtr
				   WRITE setUser
				   NOTIFY currentUserChanged)
...
Q_DECLARE_METATYPE(UserAccount2)
