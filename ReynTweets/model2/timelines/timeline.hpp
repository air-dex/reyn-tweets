...
#ifndef TIMELINE2_HPP
#define TIMELINE2_HPP
...
class Timeline2 : public QObject, public JsonArray<Tweet2>
{
	Q_OBJECT
	...
	public:
		...
		Timeline2(TimelineType tlType = INVALID);
		...
		void insertTweet(Tweet2 newTweet);
