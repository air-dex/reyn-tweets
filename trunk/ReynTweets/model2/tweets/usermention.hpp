...
class UserMention2 : public TweetEntity2
{
	...
	public:
		...
		const UserMention2 & operator=(const UserMention2 & mention);
	...
	private:
		...
		/// @param mention User Mention to copy
		void recopie(const UserMention2 & mention);
		...
		friend QDataStream & operator<<(QDataStream & out, const UserMention2 & mention);
		...
		/// @param mention Object to put in the stream
		/// @return The stream with the object
		friend QDataStream & operator>>(QDataStream & in, UserMention2 & mention);
...
Q_DECLARE_METATYPE(UserMention2)
