...
class Tweet2 : public JsonObject
{
	Q_OBJECT
	...
	public:
		...
		bool operator==(const Tweet2 & status) const;
	...
	private:
		...
		/// @param status Tweet to copy
		void recopie(const Tweet2 & status);
		...
		friend QDataStream & operator<<(QDataStream & out, const Tweet2 & tweet);
		...
		/// @param tweet Object to put in the stream
		/// @return The stream with the object
		friend QDataStream & operator>>(QDataStream & in, Tweet2 & tweet);
	...
	protected:
		...
		///
		/// retweetInfos is the attribute beneath this property.
		Q_PROPERTY(RetweetInfos2 * retweet_infos
		...
		///
		/// tweetEntities is the attribute beneath this property.
		Q_PROPERTY(TweetEntities2 * tweet_entities
				   READ getEntitiesPtr
				   WRITE setEntities
				   NOTIFY entitiesChanged)
		...
		/// @fn TweetEntities2 * getEntitiesPtr();
		/// @brief Reading the property entities
		/// @return entitiesMap
		TweetEntities2 * getEntitiesPtr();

		/// @fn void setEntities(TweetEntities2 * newEntityMap);
		/// @brief Writing the property entities
		/// @param newEntityMap New value for entities
		void setEntities(TweetEntities2 * newEntityMap);
