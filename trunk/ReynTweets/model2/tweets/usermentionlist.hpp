...
#ifndef USERMENTIONLIST2_HPP
#define USERMENTIONLIST2_HPP
...
class UserMentionList2 : public JsonArray<UserMention2>
{
	public:
		/// @fn UserMentionList();
		/// @brief Constructor
		...
		const UserMentionList2 & operator=(const UserMentionList2 & list);
	...
	protected:
		...
		friend QDataStream & operator>>(QDataStream & in,
										UserMentionList2 & list);
};

// Serialization of UserMentionList
Q_DECLARE_METATYPE(UserMentionList2)
